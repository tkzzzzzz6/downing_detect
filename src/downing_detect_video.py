...
while True:
    ...
    if warning_active:
        ...
        # 添加文本阴影效果
        cv2.putText(annotated_frame, warning_text, (text_x+2, text_y+2), cv2.FONT_HERSHEY_SIMPLEX, font_scale, (0, 0, 0), thickness*2)
        cv2.putText(annotated_frame, warning_text, (text_x, text_y), cv2.FONT_HERSHEY_SIMPLEX, font_scale, (255, 255, 255), thickness)
